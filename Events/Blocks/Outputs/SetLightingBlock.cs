...
public class SetLightingBlock : ScriptBlock
{
    ...
    public static void Init()
    {
        ...
        typeof(SceneManager).Hook(nameof(SceneManager.SetLighting),
        ...
        typeof(ColorCorrectionCurves).Hook(nameof(ColorCorrectionCurves.UpdateTextures),
    ...
    protected override void Trigger(string trigger)
    {
        ...
        SceneManager.SetLighting(new Color(R, G, B), Intensity);
        IsLocked = Lock;
    }
}